...
class _$_ParcelState extends _ParcelState {
...
abstract class _ParcelState extends ParcelState {
  const factory _ParcelState(
      ...
      final List<LatLng> polylineCoordinates}) = _$_ParcelState;
