...
import 'package:flavourfleet/presentation/pages/home_three/banner_three.dart';
import 'package:flavourfleet/presentation/pages/home_three/widgets/door_three.dart';
import 'package:flavourfleet/presentation/pages/home_three/widgets/market_three_item.dart';
import 'package:flavourfleet/presentation/pages/home_three/widgets/shop_see_all.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return UpgradeAlert(
      child: Directionality(
        ...
        child: Scaffold(
          backgroundColor: isDarkMode ? Style.mainBackDark : Style.white,
          body: SmartRefresher(
            enablePullDown: true,
            enablePullUp: false,
