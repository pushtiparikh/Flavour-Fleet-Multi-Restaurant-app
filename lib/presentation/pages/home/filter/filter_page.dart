...
import 'package:flavourfleet/application/filter/filter_notifier.dart';
import 'package:flavourfleet/application/filter/filter_state.dart';
import 'package:flavourfleet/infrastructure/models/data/take_data.dart';
...
import 'package:flavourfleet/presentation/components/custom_toggle.dart';
                    ...
                    : Column(
                        children: [
                          ...
                          CustomButton(
                            ...
                            onPressed: () {
                              context.pushRoute(
                                  ResultFilter(categoryId: widget.categoryId));
                            },
                          ),
                        ],
                      ),
