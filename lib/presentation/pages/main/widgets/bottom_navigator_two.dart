      ...
      items: [
        ...
        FloatingNavbarItem(
          customWidget: SvgPicture.asset(
            ...
            color: currentIndex == 1 ? Style.white : Style.textGrey,
          ),
        ...
        FloatingNavbarItem(
          customWidget: SvgPicture.asset(
            ...
            color: currentIndex == 2 ? Style.white : Style.textGrey,
          ),
        ...
        FloatingNavbarItem(
          customWidget: SvgPicture.asset(
            ...
            color: currentIndex == 3 ? Style.white : Style.textGrey,
          ),
          // title: AppHelpers.getTranslation(TrKeys.cart),
        ),
      ],
...
class FloatingNavbar extends StatefulWidget {
  ...
  FloatingNavbar({
    ...
    this.selectedBackgroundColor = Style.black,
    this.selectedItemColor = Style.white,
