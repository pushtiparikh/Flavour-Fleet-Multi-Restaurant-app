        ...
        items: [
          FloatingNavbarItem(
            customWidget: SvgPicture.asset(
              ...
              color: currentIndex == 0 ? Style.black : Style.textGrey,
            ),
          ...
          FloatingNavbarItem(
            customWidget: SvgPicture.asset(
              ...
              color: currentIndex == 1 ? Style.black : Style.textGrey,
            ),
          ...
          FloatingNavbarItem(
            customWidget: SvgPicture.asset(
              ...
              color: currentIndex == 2 ? Style.black : Style.textGrey,
            ),
          ...
          FloatingNavbarItem(
            customWidget: SvgPicture.asset(
              ...
              color: currentIndex == 3 ? Style.black : Style.textGrey,
            ),
            // title: AppHelpers.getTranslation(TrKeys.cart),
          ),
        ],
...
class FloatingNavbar extends StatefulWidget {
  ...
  FloatingNavbar({
    ...
    this.selectedBackgroundColor = Style.transparent,
    this.selectedItemColor = Style.black,
    this.unselectedItemColor = Style.textGrey,
