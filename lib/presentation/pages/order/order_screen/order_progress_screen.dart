...
import 'package:flavourfleet/presentation/pages/order/order_check/order_check.dart';
...
import 'package:flavourfleet/presentation/pages/shop/cart/widgets/cart_order_item.dart';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: SmartRefresher(
                        ...
                        onRefresh: () {
                          event
                            .showOrder(context, state.orderData?.id ?? 0, true);
