...
import 'package:flavourfleet/application/order/order_notifier.dart';
...
import 'package:flavourfleet/application/orders_list/orders_list_notifier.dart';
...
import 'package:flavourfleet/application/profile/profile_state.dart';
...
import 'package:flavourfleet/presentation/pages/order/order_check/price_information.dart';
import 'package:flavourfleet/presentation/pages/profile/phone_verify.dart';
      ...
      event.createOrder(
          ...
          ((AppHelpers.getPaymentType() == "admin")
              ...
              : state.shopData?.shopPayments?[paymentState.currentIndex]
                      ?.payment?.tag ??
                  ""),
          state.calculateData?.totalPrice ?? 0, onSuccess: () {
